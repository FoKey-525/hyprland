...
var Notifier = /*#__PURE__*/function () {
  function Notifier(types) {
    ...
    _defineProperty(this, "listenersEvents", {});
...
var getPlatformOs = /*#__PURE__*/function () {
    ...
    return regenerator_default().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          return _context2.abrupt("return", platformInfo.os);
        case 4:
        case "end":
...
var logsValidator = z.array(z.string()).default([]);
 ...
 */
var BrowserLogStorageProvider = /*#__PURE__*/function () {
  function BrowserLogStorageProvider() {
    _classCallCheck(this, BrowserLogStorageProvider);
  }
  _createClass(BrowserLogStorageProvider, [{
    key: "set",
    value:
    /**
    ...
    key: "get",
    value: function () {
      var _get = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee() {
        var logsFromStorage, logs;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
            ...
            case 2:
              logsFromStorage = _context.sent;
              try {
                logs = logsValidator.parse(logsFromStorage);
              } catch (e) {
                // we use here simple console, because this module is used in the logger.
                // eslint-disable-next-line no-console
                console.error("Error parsing logs from storage: ".concat(e), 'Setting logs to the empty array.');
                logs = [];
              }
  ...
  return BrowserLogStorageProvider;
}();
 ...
 * @implements {LogStorageProvider}
 */
var MemoryLogStorageProvider = /*#__PURE__*/function () {
  function MemoryLogStorageProvider() {
    _classCallCheck(this, MemoryLogStorageProvider);
    /**
     * Holds the logs in memory.
     */
    _defineProperty(this, "logs", []);
  }
  _createClass(MemoryLogStorageProvider, [{
    key: "set",
    value:
    /**
  ...
  return MemoryLogStorageProvider;
}();
...
var LogStorageManager = /*#__PURE__*/function () {
  ...
  function LogStorageManager(storage) {
    ...
    notifier.addSpecifiedListener(notifier.types.SETTING_UPDATED, /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(settingId, value) {
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _this.checkAndSwitchStorage(value);
            case 3:
            case "end":
              return _context.stop();
          }
   ...
   */
  _createClass(LogStorageManager, [{
    key: "checkAndSwitchStorage",
    value: function () {
      var _checkAndSwitchStorage = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(isDebugModeEnabled) {
        var newStorage, currentLogs, oldLogs, logs;
        return regenerator_default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              newStorage = isDebugModeEnabled ? new BrowserLogStorageProvider() : new MemoryLogStorageProvider();
            ...
            case 7:
              oldLogs = _context2.sent;
              logs = oldLogs.concat(currentLogs);
              _context2.next = 11;
              return this.currentStorage.clear();
            case 11:
              this.currentStorage = newStorage;
              _context2.next = 14;
              return this.currentStorage.set(logs);
            case 14:
            case "end":
              return _context2.stop();
          }
      ...
      function checkAndSwitchStorage(_x3) {
        return _checkAndSwitchStorage.apply(this, arguments);
      }
      return checkAndSwitchStorage;
    }()
    /**
 ...
 */
var logStorageManager = new LogStorageManager(new MemoryLogStorageProvider());
...
var MAX_LOGS_SIZE_ELEMENTS = 1000;
var SAVE_STORAGE_LOGS_TIMEOUT_MS = 5 * 1000; // 5 sec
...
var LogStorage = /*#__PURE__*/function () {
  ...
  function LogStorage() {
    var _this = this;
    var maxLogSizeElements = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : MAX_LOGS_SIZE_ELEMENTS;
    var saveStorageLogsTimeoutMs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : SAVE_STORAGE_LOGS_TIMEOUT_MS;
    _classCallCheck(this, LogStorage);
    /**
     * Maximum number of log elements.
     */
    _defineProperty(this, "maxLogSizeElements", void 0);
    /**
     * Timeout for saving logs to storage in milliseconds.
     */
    _defineProperty(this, "saveStorageLogsTimeoutMs", void 0);
    /**
     ...
     */
    _defineProperty(this, "throttledLogsSaver", throttle_default()(this.saveLogsToStorage, SAVE_STORAGE_LOGS_TIMEOUT_MS));
    /**
    ...
    _defineProperty(this, "limitLogSize", function (logs) {
      return logs.slice(-_this.maxLogSizeElements);
    });
  ...
  _createClass(LogStorage, [{
    ...
    value: function () {
      var _getLogs = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2() {
        var storage, storageLogs;
        return regenerator_default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              storage = logStorageManager.getStorage();
              _context2.next = 3;
              return storage.get();
            case 3:
...
var logStorage = new LogStorage(MAX_LOGS_SIZE_ELEMENTS);
...
var writer = {
  log: function log() {
    var _console;
    logStorage.addLog.apply(logStorage, arguments);
...
log.currentLevel = IS_DEV ? LogLevel.Trace : LogLevel.Debug;
...
var Messenger = /*#__PURE__*/function () {
  function Messenger() {
    ...
    _defineProperty(this, "createEventListener", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3(events, callback) {
        var eventListener, listenerId, onUpdateListeners, messageHandler, onUnload;
        return regenerator_default().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
            ...
            case 3:
              listenerId = _context3.sent;
              onUpdateListeners = /*#__PURE__*/function () {
                ...
                return function onUpdateListeners() {
                  return _ref2.apply(this, arguments);
                };
              }();
              ...
              return _context3.abrupt("return", onUnload);
            case 11:
            case "end":
              return _context3.stop();
          }
  ...
  _createClass(Messenger, [{
    ...
    key: "getLimitedOfferData",
    value: function () {
      var _getLimitedOfferData = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee6() {
        var type;
        return regenerator_default().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              type = MessageType.GET_LIMITED_OFFER_DATA;
      ...
      function getLimitedOfferData() {
        return _getLimitedOfferData.apply(this, arguments);
      }
      return getLimitedOfferData;
    }()
    /**
    ...
    key: "forceUpdateLocations",
    value: function () {
      var _forceUpdateLocations = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee7() {
        var type;
        return regenerator_default().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              type = MessageType.FORCE_UPDATE_LOCATIONS;
      ...
      function forceUpdateLocations() {
        return _forceUpdateLocations.apply(this, arguments);
      }
      return forceUpdateLocations;
    }()
  }, {
    key: "getOptionsData",
    value: function () {
      var _getOptionsData = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee8() {
        var type;
    ...
    value: function () {
      var _getVpnFailurePage = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee9() {
        var type;
    ...
    key: "openOptionsPage",
    value: function () {
      var _openOptionsPage = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee10() {
        var type;
    ...
    key: "openFreeGbsPage",
    value: function () {
      var _openFreeGbsPage = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee11() {
        var type;
    ...
    key: "getBonusesData",
    value: function () {
      var _getBonusesData = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee12() {
        var type;
    ...
    value: function () {
      var _setCurrentLocation = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee13(location, isSelectedByUser) {
        var type;
    ...
    value: function () {
      var _authenticateUser = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee14(credentials) {
        var type;
    ...
    value: function () {
      var _deauthenticateUser = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee15() {
        var type;
    ...
    key: "updateAuthCache",
    value: function () {
      var _updateAuthCache = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee16(field, value) {
        var type;
    ...
    key: "getAuthCache",
    value: function () {
      var _getAuthCache = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee17() {
        var type;
    ...
    key: "clearAuthCache",
    value: function () {
      var _clearAuthCache = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee18() {
        var type;
    ...
    value: function () {
      var _getCanControlProxy = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee19() {
        var type;
    ...
    key: "enableProxy",
    value: function () {
      var _enableProxy = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee20(force) {
        var type;
    ...
    key: "disableProxy",
    value: function () {
      var _disableProxy = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee21(force) {
        var type;
    ...
    value: function () {
      var _addUrlToExclusions = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee22(url) {
        var type;
    ...
    key: "removeExclusion",
    value: function () {
      var _removeExclusion = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee23(id) {
        var type;
    ...
    key: "disableVpnByUrl",
    value: function () {
      var _disableVpnByUrl = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee24(url) {
        var type;
    ...
    key: "enableVpnByUrl",
    value: function () {
      var _enableVpnByUrl = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee25(url) {
        var type;
    ...
    value: function () {
      var _toggleExclusionState = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee26(id) {
        var type;
    ...
    value: function () {
      var _restoreExclusions = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee27() {
        var type;
    ...
    key: "toggleServices",
    value: function () {
      var _toggleServices = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee28(ids) {
        var type;
    ...
    value: function () {
      var _resetServiceData = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee29(serviceId) {
        var type;
    ...
    value: function () {
      var _clearExclusionsList = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee30() {
        var type;
    ...
    key: "checkEmail",
    value: function () {
      var _checkEmail = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee31(email) {
        var type;
    ...
    value: function () {
      var _disableOtherExtensions = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee32() {
        var type;
    ...
    key: "registerUser",
    value: function () {
      var _registerUser = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee33(credentials) {
        var type;
    ...
    key: "isAuthenticated",
    value: function () {
      var _isAuthenticated = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee34() {
        var type;
    ...
    key: "startSocialAuth",
    value: function () {
      var _startSocialAuth = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee35(provider, marketingConsent) {
        var type;
    ...
    value: function () {
      var _clearPermissionsError = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee36() {
        var type;
    ...
    value: function () {
      var _checkPermissions = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee37() {
        var type;
    ...
    value: function () {
      var _getExclusionsInverted = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee38() {
        var type;
    ...
    key: "getSetting",
    value: function () {
      var _getSetting = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee39(settingId) {
        var type;
    ...
    key: "setSetting",
    value: function () {
      var _setSetting = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee40(settingId, value) {
        var type;
    ...
    key: "getUsername",
    value: function () {
      var _getUsername = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee41() {
        var type;
    ...
    value: function () {
      var _getExclusionsData = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee42() {
        var type;
    ...
    value: function () {
      var _setExclusionsMode = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee43(mode) {
        var type;
    ...
    value: function () {
      var _getSelectedLocation = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee44() {
        var type;
    ...
    value: function () {
      var _checkIsPremiumToken = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee45() {
        var type;
    ...
    value: function () {
      var _setRateModalViewed = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee46() {
        var type;
    ...
    value: function () {
      var _setNotificationViewed = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee47(withDelay) {
        var type;
    ...
    value: function () {
      var _setHintPopupViewed = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee48() {
        var type;
    ...
    key: "openTab",
    value: function () {
      var _openTab = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee49(url) {
        var type;
    ...
    key: "reportBug",
    value: function () {
      var _reportBug = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee50(email, message, includeLog) {
        var type;
    ...
    value: function () {
      var _openPremiumPromoPage = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee51() {
        var type;
    ...
    key: "setFlag",
    value: function () {
      var _setFlag = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee52(key, value) {
        var type;
        return regenerator_default().wrap(function _callee52$(_context52) {
          while (1) switch (_context52.prev = _context52.next) {
            case 0:
              type = MessageType.SET_FLAG;
              return _context52.abrupt("return", this.sendMessage(type, {
                key: key,
                value: value
              }));
            case 2:
    ...
    key: "setEmailConfirmationAuthId",
    value: function setEmailConfirmationAuthId(authId) {
      var type = MessageType.SET_EMAIL_CONFIRMATION_AUTH_ID;
      return this.sendMessage(type, {
        authId: authId
      });
    }
    ...
    key: "resendEmailConfirmationCode",
    value: function resendEmailConfirmationCode() {
      var type = MessageType.RESEND_EMAIL_CONFIRMATION_CODE;
      return this.sendMessage(type);
    }
    ...
    key: "getResendCodeCountdown",
    value: function () {
      var _getResendCodeCountdown = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee53() {
        var type;
        return regenerator_default().wrap(function _callee53$(_context53) {
          while (1) switch (_context53.prev = _context53.next) {
            case 0:
              type = MessageType.GET_RESEND_CODE_COUNTDOWN;
              return _context53.abrupt("return", this.sendMessage(type));
            case 2:
            case "end":
      ...
      function getResendCodeCountdown() {
        return _getResendCodeCountdown.apply(this, arguments);
      }
      return getResendCodeCountdown;
    }()
    /**
    ...
    key: "recalculatePings",
    value: function recalculatePings() {
      var type = MessageType.RECALCULATE_PINGS;
      return this.sendMessage(type);
    }
  }]);
  return Messenger;
