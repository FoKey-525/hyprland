...
var CUSTOM_PROTOCOL = 'adguardvpnext:';
var LINK_TAG_NAME = 'a';

// @ts-ignore
// eslint-disable-next-line @typescript-eslint/no-use-before-define
var custom_dns_links_browser = chrome || custom_dns_links_browser;
 ...
 */
var getSubscriptionParams = function getSubscriptionParams(url) {
  var urlObject;
  try {
    urlObject = new URL(url);
  } catch (e) {
    log.error("Failed to parse URL: ".concat(url, ", due to error: ").concat(e));
    return {
      name: null,
      address: null
    };
 ...
 */
var onLinkClicked = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(event) {
    var _subParams$address, _ref2;
    var target, subParams, address, name;
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          if (!(event.button === 2)) {
        ...
        case 5:
          ...
          subParams = getSubscriptionParams(target.href);
          address = (_subParams$address = subParams.address) === null || _subParams$address === void 0 ? void 0 : _subParams$address.trim();
          name = (_ref2 = subParams.name || address) === null || _ref2 === void 0 ? void 0 : _ref2.trim();
          if (address) {
            _context.next = 12;
            break;
          }
        ...
        case 12:
          _context.next = 14;
          return custom_dns_links_browser.runtime.sendMessage({
  ...
  return function onLinkClicked(_x) {
    return _ref.apply(this, arguments);
  };
}();
