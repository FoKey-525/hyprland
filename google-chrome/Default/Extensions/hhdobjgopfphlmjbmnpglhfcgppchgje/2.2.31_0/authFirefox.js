...
var bind = __webpack_require__(4332);
var GetIntrinsic = __webpack_require__(6207);
...
var implementation = __webpack_require__(5835);
...
var implementation = __webpack_require__(3625);
...
var implementation = __webpack_require__(5355);
...
var bind = __webpack_require__(3861);
...
/* harmony default export */ const punycode_es6 = ((/* unused pure expression or super */ null && (punycode_es6_punycode)));
...
var getLocationWithLowestPing = function getLocationWithLowestPing(locations) {
  ...
  var locationsWithPings = locations.filter(function (location) {
    return location.ping && location.ping > 0;
  });
 ...
 * @param minDurationMs
 */
var sleepIfNecessary = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(entryTimeMs, minDurationMs) {
 ...
 */
var getForwarderUrl = function getForwarderUrl(forwarderDomain, query) {
  return "https://".concat(forwarderDomain, "/forward.html?").concat(query);
};
 ...
 */
var BrowserName = /*#__PURE__*/function (BrowserName) {
...
var SystemName = /*#__PURE__*/function (SystemName) {
...
var Prefs = {
  get ICONS() {
    return lazyGet(Prefs, 'ICONS', function () {
      return {
        ENABLED: {
          19: getUrl("".concat(ICONS_PATH, "/enabled-19.png")),
          38: getUrl("".concat(ICONS_PATH, "/enabled-38.png")),
          128: getUrl("".concat(ICONS_PATH, "/enabled-128.png"))
        },
        DISABLED: {
          19: getUrl("".concat(ICONS_PATH, "/disabled-19.png")),
          38: getUrl("".concat(ICONS_PATH, "/disabled-38.png")),
          128: getUrl("".concat(ICONS_PATH, "/disabled-128.png"))
        },
        TRAFFIC_OFF: {
          19: getUrl("".concat(ICONS_PATH, "/traffic-off-19.png")),
          38: getUrl("".concat(ICONS_PATH, "/traffic-off-38.png")),
          128: getUrl("".concat(ICONS_PATH, "/traffic-off-128.png"))
        }
      };
    });
  },
  ...
  get browser() {
    return lazyGet(Prefs, 'browser', function () {
      var browser;
      ...
      return regenerator_default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return runtime.getPlatformOs();
          case 3:
            _this.os = _context.sent;
          case 4:
            return _context.abrupt("return", _this.os);
          case 5:
          case "end":
            return _context.stop();
        }
    ...
    return asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2() {
      ...
      return regenerator_default().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 2:
            os = _context2.sent;
            return _context2.abrupt("return", os === SystemName.Windows);
          case 4:
          case "end":
            return _context2.stop();
        }
    ...
    return asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3() {
      ...
      return regenerator_default().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 2:
            os = _context3.sent;
            return _context3.abrupt("return", os === SystemName.MacOS);
          case 4:
          case "end":
...
var Storage = /*#__PURE__*/function () {
  ...
  _createClass(Storage, [{
    key: "set",
    value: function () {
      var _set = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(key, data) {
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
    ...
    key: "get",
    value: function () {
      var _get = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(key) {
        var value;
        return regenerator_default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
    ...
    key: "remove",
    value: function () {
      var _remove = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3(key) {
        return regenerator_default().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
...
var BrowserLogStorageProvider = /*#__PURE__*/function () {
  ...
  _createClass(BrowserLogStorageProvider, [{
    ...
    key: "get",
    value: function () {
      var _get = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee() {
...
var LogStorageManager = /*#__PURE__*/function () {
  ...
  function LogStorageManager(storage) {
    ...
    notifier.addSpecifiedListener(notifier.types.SETTING_UPDATED, /*#__PURE__*/function () {
      var _ref = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee(settingId, value) {
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
  ...
  _createClass(LogStorageManager, [{
    ...
    value: function () {
      var _checkAndSwitchStorage = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2(isDebugModeEnabled) {
...
var LogStorage = /*#__PURE__*/function () {
  ...
  _createClass(LogStorage, [{
     ...
     */
    function () {
      var _getLogsString = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee() {
        var logs;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    key: "getLogs",
    value: function () {
      var _getLogs = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee2() {
     ...
     */
    function () {
      var _saveLogsToStorage = asyncToGenerator_asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee3() {
        var logs, storage;
        return regenerator_default().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
...
;// CONCATENATED MODULE: ./src/common/utils/auth.ts
 ...
 */
var thankYouPageAuthHandler = function thankYouPageAuthHandler(data) {
...
;// CONCATENATED MODULE: ./src/custom-protocol-handler/authFirefox.ts
 ...
 */
var THANKYOU_PAGE_PATHNAME = '//authorized-thankyou-page';
 ...
 */
var getSecondItemAfterSplit = function getSecondItemAfterSplit(str, separator) {
 ...
 * @returns Matched url.
 */
var getMatchedUrl = function getMatchedUrl(href) {
 ...
 */
var getRawAuthData = function getRawAuthData(matchedUrl, pathname) {
  var queryString = getSecondItemAfterSplit(matchedUrl, "".concat(pathname).concat(QUERY_STRING_START));
  return lib_default().parse(queryString);
};
...
(function () {
  ...
  // url from the hash
  var matchedUrlStr = decodeURIComponent(getMatchedUrl(window.location.href)).trim();
  if (matchedUrlStr.length === 0) {
    log.error('Empty matched url');
    return;
  }
  var matchedUrl = new URL(matchedUrlStr);
  var pathname = matchedUrl.pathname;
  if (pathname !== THANKYOU_PAGE_PATHNAME) {
    log.error("Unknown pathname: ".concat(pathname));
    return;
  }
  var data = getRawAuthData(matchedUrlStr, THANKYOU_PAGE_PATHNAME);
